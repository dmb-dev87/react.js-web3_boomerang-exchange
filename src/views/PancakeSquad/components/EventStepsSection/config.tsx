import { Button } from '@boomerangexchange/uikit'
  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active BoomerangExchange Profile to buy Minting Tickets and mint a Pancake Squad NFT!')],
      buttons: (
        <>
