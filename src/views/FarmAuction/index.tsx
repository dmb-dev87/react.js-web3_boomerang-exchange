...
import { Button, Heading, Text, Flex, Link, Breadcrumbs } from '@boomerangexchange/uikit'
        ...
        <Flex flexDirection={['column-reverse', null, 'row']}>
          <Left>
            ...
            <Text color="textSubtle" mb="24px">
              {t('Each week, qualifying projects can bid CAKE for the right to host a 7-day Farm on BoomerangExchange.')}
            </Text>
