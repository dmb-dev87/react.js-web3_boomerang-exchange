...
const config = [
  {
    ...
    description: [
      ...
      <Trans>
        In the Public Sale, everyone with an active BoomerangExchange profile can commit. However the maximum amount of CAKE
  ...
  },
  {
    ...
    description: [
      ...
      <Trans>Just remember you need an active BoomerangExchange Profile in order to participate.</Trans>,
    ],
  },
  {
