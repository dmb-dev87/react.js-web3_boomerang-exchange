import { IconButton, Text, Skeleton, Button, AutoRenewIcon, ChevronRightIcon, Message } from '@boomerangexchange/uikit'
          ...
          <>
            ...
            {total === 0 ? (
              <Message variant="danger" mb="12px">
                <Text color="danger">
                  {t(
                    'Hold some CAKE in your wallet or on BoomerangExchange at the snapshot block to get voting power for future proposals.',
                  )}
                </Text>
              </Message>
            ) : (
