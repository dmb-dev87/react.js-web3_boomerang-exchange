import { LinkExternal } from '@boomerangexchange/uikit'
  ...
  return [
    {
      ...
      description: [
        ...
        t('You can instantly swap your WBNB for BNB with no trading fees on BoomerangExchange.'),
      ],
    },
    {
      ...
      description: [
        t(
          'Soon! The current NFT Market is a basic version (phase 1), with early access to trading BoomerangExchange NFTs only.',
        ),
    ...
    },
    {
      ...
      description: [
        t(
          '100% of all platform fees taken by BoomerangExchange from sales are used to buy back and BURN CAKE tokens in our weekly CAKE burns.',
        ),
        t(
